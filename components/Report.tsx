...
// //              <div className="px-3 py-1 bg-green-100 dark:bg-green-500/20 border-b border-green-200 dark:border-green-500/30 text-sm font-bold text-green-700 dark:text-green-400 uppercase tracking-wider">
// //                Suggested Fix
// //              </div>
// //              <pre className="p-3 overflow-x-auto text-sm font-mono text-gray-800 dark:text-gray-300">
// //                {code}
// //              </pre>
// //            </div>
// //         )}
...
// //         </div>
// //         <div className={`
// //            px-3 py-1 rounded-full text-sm font-bold uppercase tracking-wider whitespace-nowrap
// //            ${isSecurity 
...
// //            <div className="flex items-center gap-2 mb-3 text-sm font-mono text-gray-500 dark:text-gray-400">
...
// //               <pre className="p-4 overflow-x-auto code-scroll text-sm font-mono text-gray-800 dark:text-gray-300">
...
// //             <div className="flex items-center gap-2 mb-3 text-sm font-bold uppercase tracking-wider text-green-600 dark:text-green-400">
...
//        Suggested Fix
//      </div>
//      <CodeHighlight code={code} language="python" />
//    </div>
//         )}
//         {footer && <p className="whitespace-pre-wrap">{footer}</p>}
//       </div>
...
//         {/* Left: The Problem WITH LINE NUMBERS */}
//         <div className="p-6 bg-red-50/10 dark:bg-red-500/5 relative group">
//            <div className="flex items-center gap-2 mb-3 text-sm font-mono text-gray-500 dark:text-gray-400">
//               <FileCode className="w-3 h-3" />
//               <span>{finding.file_name}</span>
...
//            {/* USE CodeHighlight with syntax highlighting */}
//     <CodeBlockWithLineNumbers 
//      code={finding.code_snippet}
//      startLine={finding.line_start}
//      highlightedLines={finding.highlighted_lines}
//    />
// </div>
...
//             </button>
//             <div className="text-sm text-gray-500 dark:text-gray-600 uppercase tracking-widest font-bold">Confidential Audit Report</div>
//         </div>
...
//                         <span className="text-sm text-gray-500 font-bold uppercase mt-1">/ 100</span>
//                     </div>
//                 </div>
//             </div>
...
//                         <p className="text-sm text-gray-500 uppercase font-bold tracking-wider">Security Risks</p>
//                     </div>
...
//                         <p className="text-sm text-gray-500 uppercase font-bold tracking-wider">Weaknesses</p>
//                     </div>
...
//                 <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Issues Identified</h3>
...
// // Enhanced CodeBlockWithLineNumbers with syntax highlighting
// const CodeBlockWithLineNumbers: React.FC<{ 
//   code: string; 
//   startLine: number;
//   highlightedLines?: number[];
// }> = ({ code, startLine, highlightedLines = [] }) => {
//   const lines = code.split('\n');
  
//   // Simple Python syntax highlighting
//   const highlightSyntax = (line: string) => {
//     return line
//       // Keywords (def, class, import, for, if, try, except, return, etc.)
//       .replace(/\b(def|class|import|from|for|if|elif|else|while|try|except|return|with|as|in|and|or|not|True|False|None|break|continue|pass|raise|finally)\b/g, 
...
//         {/* Line numbers column */}
//         <div className="py-4 px-3 bg-gray-50 dark:bg-black/60 text-gray-500 dark:text-gray-600 select-none border-r border-gray-200 dark:border-white/10">
//           {lines.map((_, index) => {
...
//               <div 
//                 key={index}
//                 className={`text-right leading-relaxed px-2 ${
//                   isHighlighted 
//                     ? 'bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 font-bold' 
//                     : ''
//                 }`}
//               >
//                 {lineNum}
...
//                   isHighlighted 
//                     ? 'bg-red-100 dark:bg-red-500/10 -mx-4 px-4 border-l-4 border-red-500' 
//                     : ''
//                 }`}
//               >
//                 <code 
...
// Always-dark code block with line numbers - consistent across light/dark modes
const CodeBlockWithLineNumbers: React.FC<{ 
  code: string; 
  startLine: number;
  highlightedLines?: number[];
  ...
  return (
    <div className="relative rounded-lg overflow-hidden border border-red-200 dark:border-red-500/20 bg-[#1E1E1E]">
      <div className="absolute top-0 left-0 bottom-0 w-1 bg-red-500"></div>
      <div className="flex font-mono text-base">
        {/* Line numbers column - always dark */}
        <div className="py-4 px-3 bg-[#252526] text-gray-500 select-none border-r border-[#3E3E42]">
          {lines.map((_, index) => {
            const lineNum = startLine + index;
            const isHighlighted = highlightedLines.includes(lineNum);
            return (
        ...
        {/* Code column - always dark with VS Code Dark+ theme */}
        <div className="flex-1 overflow-x-auto">
          <SyntaxHighlighter
            ...
            lineProps={(lineNumber) => {
              const actualLineNum = startLine + lineNumber - 1;
              const isHighlighted = highlightedLines.includes(actualLineNum);
              return {
                style: {
                  backgroundColor: isHighlighted ? 'rgba(239, 68, 68, 0.15)' : 'transparent',
                  borderLeft: isHighlighted ? '4px solid rgb(239, 68, 68)' : 'none',
